...
export default class Splash extends React.Component {
    ...
    onUnsaveProductClick(){
        this.dropDownAlertRef.alertWithType('success', 'Unsaved !', "Product unaved Succcessfully !",null,1500)
    }
    ...
    render () {
      return (
        ...
        <View style={{marginHorizontal:wp('5%'),flexDirection:'row',}}>
            <Text style={{color:'#000',fontSize:hp('2.5%'),fontWeight:"bold"}}>{this.state.renderLanguage.featured}</Text>
        </View>
